...
function SolutionSection() {
  const steps = [
    ...
    },
    {
      n: "٥",
      icon: Send,
      title: "توليد المحتوى ولوحة KPIs",
      body: "نصوص ومنشورات جاهزة للنسخ + لوحة لتتبع نتائجك مع استيراد بياناتك من Meta و Google.",
    },
  ];
...
function PricingSection() {
  const features = [
    ...
    "أفكار ونصوص محتوى جاهزة للنسخ",
    "تقويم نشر يومي مقترح",
    "لوحة KPIs مع استيراد بيانات Meta/Google",
    "تقارير PDF احترافية بالعربي",
    "تحديث التحليل تلقائياً كل أسبوعين",
    "دعم عبر واتساب خلال ساعات العمل",
  ];
